...
public final class Generators {
    ...
    public static GeneratorPair getGeneratorsForRibWithoutPresenterAndViewAndScreen(String packageName, String ribName, boolean isKotlinSelected) {
        GeneratorPair generatorPair = getGeneratorsForRibWithPresenterAndView(packageName, ribName, isKotlinSelected);
        ScreenGenerator screenGenerator = new ScreenGenerator(packageName, ribName, isKotlinSelected);

        generatorPair.getMainSourceSetGenerators().add(screenGenerator);
