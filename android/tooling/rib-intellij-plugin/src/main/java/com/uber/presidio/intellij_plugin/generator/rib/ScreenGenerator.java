...
public class ScreenGenerator extends Generator {
    ...
    private static final String TEMPLATE_NAME = "RibScreen";

    public ScreenGenerator(String packageName, String ribName, boolean isKotlinSelected) {
        super(packageName, ribName, isKotlinSelected, TEMPLATE_NAME);
    }

    @Override
    public String getClassName() {
        return String.format("%sScreen", getRibName());
    }
}
